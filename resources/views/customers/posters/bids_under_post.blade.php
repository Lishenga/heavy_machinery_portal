            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <h4 style="margin-left: 150px" class="page-title">Bids for Post</h4>

                    </div>

                    <div class="col-sm-6">

                        <form style="margin-right: 150px" role="form" method="POST" action="{{url('/customers/post/acceptedbid')}}" enctype="multipart/form-data">
                            ...
                            <div class="modal-footer form-group">
                                ...
                                <button id="prev" type="submit" class="btn btn-info btn-small">Check Accepted Bid</button>
