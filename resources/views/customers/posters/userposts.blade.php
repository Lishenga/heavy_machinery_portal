            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <h4 class="page-title" style="text-align: center;">Posts for Poster</h4>
                            ...
                            <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                @foreach($customers as $customer)  
                                    ...
                                    <tr>
                                        ...
                                        <td>{{@$customer->min_days}}</td>
                                        <td>{{@$customer->max_days}}</td>
                                        <td>{{@$customer->price}}</td>
                                        <td>{{@$customer->county}} (County) {{@$customer->ward_or_town}} (Ward)</td>
                                        ...
                                        <td>
                                            <form role="form" method="POST" action="{{url('customers/bids_under_post')}}" enctype="multipart/form-data">
                                                ...
                                                <input type="hidden" name="user_id" value="{{$bidder_id}}">

                                                <div class="modal-footer form-group">

                                                    <button id="next" type="submit" class="btn waves-effect waves-light btn-primary"><i class="fa fa-pencil"></i></button>
