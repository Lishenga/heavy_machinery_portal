    ...
    $( document ).ready(function() {
        $("form").ready(function(){
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <form role="form" method="POST" action="{{url('customers/bids')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-footer form-group">
                                        ...
                                        <button type="submit" class="dropdown-item btn btn-info btn-small">Sell all bids</button>

                                    </div>

                                </form>
                                <div class="dropdown-divider"></div>
                                <form role="form" method="POST" action="{{url('customers/acceptedbids')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-footer form-group">
                                        ...
                                        <button type="submit" class="dropdown-item btn btn-info btn-small">See accepted bids</button>
                                ...
                                <form role="form" method="POST" action="{{url('customers/items')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-footer form-group">
                                        ...
                                        <button type="submit" class="dropdown-item btn btn-info btn-small">Items</button>
            ...
            <div class="row">
               ...
               <div class="col-md-9">
                <form method="POST" action="{{ url('/customers/update_bidders') }}">
                  <div class="row">
